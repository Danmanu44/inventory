                ...
                <div class="card p-3">
                    ...
                    <div class="card-body">
                        <form action="{{ route('client.store') }}" method="POST">
                            ...
                            <div class="input-group mb-3">
                                <input type="number" name="ward" class="form-control @error('ward') is-invalid @enderror" placeholder="Ward" value="{{ old('ward') }}">
                                @error('ward')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                            ...
                            <div class="input-group mb-3">
                                <input type="number" name="polling_unit" class="form-control @error('polling_unit') is-invalid @enderror" placeholder="Polling Unit" value="{{ old('polling_unit') }}">
                                @error('polling_unit')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
